...
| **Answer file per case** | 20 structured Markdown reports in [`backend/submission_outputs/`](./backend/submission_outputs/). |
...
```
Output will be saved to `backend/submission_outputs/`.
